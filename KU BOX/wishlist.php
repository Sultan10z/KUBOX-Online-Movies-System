...
<section class="wishlist">
   ...
   <?php
      ...
      if(($select_wishlist->rowCount() > 0)&&($select_products->rowCount() > 0)){
         while(($fetch_wishlist = $select_wishlist->fetch(PDO::FETCH_ASSOC))&&$fetch_products = $select_products->fetch(PDO::FETCH_ASSOC)){ 
